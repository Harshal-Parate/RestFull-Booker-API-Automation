...
public final class CreateBookingFilePaths {
    ...
    @Getter
    public static String validCreateBookingPayload = "src/test/resources/Data/TestPayloadFiles/CreateBookingData/valid-data.json";

    @Getter
    public static String invalidCreateBookingPayload = "";

    @Getter
    public static String validCreateBookingResponse = "src/test/resources/Data/ResponseData/Create Booking Response/Response-data.json";
